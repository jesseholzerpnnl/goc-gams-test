...
# a file for storing messages that should be displayed to the log
# not sure if there is any better way to display to log/console
file messagefile /'message.txt'/;
...
#loop(k0$(Ctg(k0) and sameas(k0, 'L_000490HONEAPATH10-000117DONALDS0C1')),
  ...
  # print a message to log/console - what contingency are we on?
  put messagefile;
  put "in contingency loop starting contingency num: " k0.ord:0:0 ", label: '" k0.tl:0 "' " /;
  putclose messagefile;
  execute "cat message.txt";
